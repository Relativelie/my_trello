import { InputFieldActionTypes, InputFieldAction } from "../../types/inputFieldTypes";


export const nameValidationOn = (nameValue: string, index: string[], typeOfElement: string): InputFieldAction => ({
