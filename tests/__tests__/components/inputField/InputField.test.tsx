...
describe('Input field component', () => {
  test('snapshot - List Input field component', () => {
    const tree = render(
      <NameInput index={0} typeOfElement="list" taskValue="" />,
    );
  ...
  test('snapshot - Task Input field component', () => {
    const tree = render(
      <NameInput index={[0, 0]} typeOfElement="task" taskValue="0 123" />,
    );
    expect(tree).toMatchSnapshot();
  });

  test('List input - show and hide(with enter) input field', () => {
    render(<NameInput index={0} typeOfElement="list" taskValue="" />);
  ...
  test('Task input - show and hide(with enter) input field', () => {
    render(<NameInput index={[0, 0]} typeOfElement="task" taskValue="0 123" />);
