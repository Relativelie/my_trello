import {
  ...
  removeSubtask,
  renameTask,
} from '../../../src/store/actions/subtaskActions';
import { TasksActionTypes } from '../../../src/types/subtaskTypes';
...
describe('tasks actions', () => {
  test('action to remove task', () => {
    ...
    expect(removeSubtask(listIndex, taskIndex)).toEqual({
  ...
  test('action to drag and drop only tasks', () => {
    ...
    expect(
      dragDropTasks(indexListTo, indexListFrom, indexTaskTo, indexTaskFrom),
    ).toEqual({
